require { baseUrl: "/javascripts/compiled" }, ["order!vendor/underscore", "order!vendor/backbone", "order!member-timeline/views/item_view", "order!member-timeline/models/item"], (underscore, backbone, ItemView, Item) ->
